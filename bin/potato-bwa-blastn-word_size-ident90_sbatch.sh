...
#SBATCH --job-name=Potato_bwa-blast-word_size-ident90
#SBATCH --nodes=4
...
DB_BLAST_PATHOGEN=database/St_path_db
...
do
    ...
    srun --nodes=1 --ntasks=1 --quiet \
        cat $UNMAPPED | seqkit fq2fa | \
        blastn -num_threads $CPUS -task megablast -word_size 12 -evalue $EVAL -perc_identity 90 -outfmt 6 -db $DB_BLAST_PATHOGEN >> $BLAST_OUT &
done
wait
...
do
    ...
    unmatched=$((potato_reads-pathogen_match))
