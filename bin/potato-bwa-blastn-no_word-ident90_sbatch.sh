...
#SBATCH --job-name=Potato_bwa-blast-no_word-ident90
#SBATCH --nodes=4
...
do
    ...
    srun --nodes=1 --ntasks=1 --quiet \
        ...
        blastn -num_threads $CPUS -task megablast -evalue $EVAL -perc_identity $IDENTITY -outfmt 6 -db $DB_BLAST_PATHOGEN >> $BLAST_OUT &
done
wait
